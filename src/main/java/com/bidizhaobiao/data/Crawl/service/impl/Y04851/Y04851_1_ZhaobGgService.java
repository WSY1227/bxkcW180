package com.bidizhaobiao.data.Crawl.service.impl.Y04851;
 ...
 * 原网站：http://www.ytfybjy.cn/zbcg
 * 主页：http://www.ytfybjy.cn
 **/
@Service("Y04851_1_ZhaobGgService")
public class Y04851_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.ytfybjy.cn/zbcg";
    public String baseUrl = "http://www.ytfybjy.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04851-1";
    // 网站名称
    public String sourceName = "烟台市芝罘区妇幼保健院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select(".ryjob>ul>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("doc.article_title").first();
