package com.bidizhaobiao.data.Crawl.service.impl.SJ_24756;
 ...
 * 原网站：http://www.hncg.com.cn/List.aspx?ClassId=195&ParentId=189
 * 主页：http://www.hncg.com.cn
 **/
@Service
public class SJ_24756_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hncg.com.cn/List.aspx?ClassId=195&ParentId=189&page=1";
    public String baseUrl = "http://www.hncg.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24756";
    // 网站名称
    public String sourceName = "海南省建设集团有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select(".article-list>ul>li");
                ...
                Element nextPage = doc.select(".pg a:contains(>)").first();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.article-main").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("p.ah-post").remove();
