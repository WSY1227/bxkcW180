 ...
 * 原网站：http://ec.hbncp.com.cn/#/home/bids
 * 主页：http://ec.hbncp.com.cn/#/home
 **/
@Service
public class QX_24613_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://ebs.hbncp.com.cn/ebsapi/project/release/announcement/public/listavailable";
    public String baseUrl = "http://ec.hbncp.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24613-1";
    // 网站名称
            ...
            if (url.equals(listUrl)) {
                ...
                if (rows.size() > 0) {
                    for (int i = 0; i < rows.size(); i++) {
                        ...
                        String link = "https://ebs.hbncp.com.cn/ebsapi/project//release/announcement/public/website/get?id=" + id;
                        String detailLink = "http://ec.hbncp.com.cn/#/home/bids/detail?id=" + id;

                        String date = "";
                        if (row.getString("proBulletinReleaseTime") != null) {
                            date = row.getString("proBulletinReleaseTime");
                        ...
                        String title = row.getString("bulletinTitle").trim();
                ...
                if (branch != null) {
                    ...
                    String html = dataJSON.getString("proBulletinNote");
                    ...
                    if (contentElement != null) {
                        ...
                        title = dataJSON.getString("bulletinTitle");
                        contentElement.select("script").remove();
                        contentElement.select("style").remove();
                        JSONArray filesProving = dataJSON.getJSONArray("filesCode");
