 ...
 * 原网站：http://ggzy.huangzhou.gov.cn/ceinwz/xwmore.aspx?id=21&showdate=1&FromUrl=tzgg
 * 主页：http://ggzy.huangzhou.gov.cn
 **/

@Service("QX_01707_1_GonggBgService")
public class QX_01707_1_GonggBgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://ggzy.huangzhou.gov.cn/ceinwz/xwmore.aspx?id=21&showdate=1&FromUrl=tzgg&page=1";

    public String baseUrl = "http://ggzy.huangzhou.gov.cn";

    // 抓取网站的相关配置，包括：编码、抓取间隔、重试次数等
    Site site = Site.me().setCycleRetryTimes(3).setTimeOut(30000).setSleepTime(20).setCharset("GBK");
    // 网站编号
    public String sourceNum = "01707-1";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("page=")) {
                ...
                if (serviceContext.getPageNum() == 1 && document.select("span#ctl00_ContentPlaceHolder1_BestNewsListALL_myGV_ctl13_lblPage").first() != null) {
                    String pageCount = document.select("span#ctl00_ContentPlaceHolder1_BestNewsListALL_myGV_ctl13_lblPage").first().text().trim();
                    String pageReg = "共(\\d{1,5})页";
                ...
                Elements trs = document.select("table#ctl00_ContentPlaceHolder1_BestNewsListALL_myGV > tbody > tr:has(a)");
                if (trs.size() > 1) {
    ...
    public Request getRequest(String link, String __VIEWSTATE, String __EVENTVALIDATION) {
        ...
        map.put("ctl00$ContentPlaceHolder1$BestNewsListALL$txtTitle", "");
        map.put("ctl00$ContentPlaceHolder1$BestNewsListALL$myGV$ctl13$inPageNum", "");
