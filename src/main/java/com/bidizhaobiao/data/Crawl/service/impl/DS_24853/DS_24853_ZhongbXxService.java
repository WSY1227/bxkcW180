package com.bidizhaobiao.data.Crawl.service.impl.DS_24853;
 ...
 * 原网站：http://cms.huaian.gov.cn/cmsweb/zwgk/sj/indexdept.html?r=0000000064a8f16d0164ad1d9d730006&orgId=2c94939268fffddd016900af14c40057&orgName=%E6%B7%AE%E5%AE%89%E5%B8%82%E4%BF%A1%E8%AE%BF%E5%B1%80&topic=5447
 * 主页：http://xfj.huaian.gov.cn
 **/
@Service
public class DS_24853_ZhongbXxService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "24853";
    // 网站名称
    public String sourceName = "淮安市信访局";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?page=")) {
                JSONObject dataJSON = JSONObject.parseObject(page.getRawText()).getJSONObject("value");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.wk").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.bt").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("table").first().remove();
