package com.bidizhaobiao.data.Crawl.service.impl.XX8428;
 ...
 * 原网站：https://www.jngyjsxy.cn/h-col-126.html
 * 主页：https://www.jngyjsxy.cn
 **/
@Service
public class XX8428_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.jngyjsxy.cn/h-col-126.html";
    public String baseUrl = "https://www.jngyjsxy.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8428-1";
    // 网站名称
    public String sourceName = "济宁市工业技师学院";
    // 信息源
    ...
    // 设置城市
    public String city = "济宁";
    // 设置县
    public String district = "兖州";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select(".news_list_wrap>div>a");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(element.select(".news_list_item_date").text());
                        if (dateMat.find()) {
                        ...
                        String title = a.select(".news_list_item_header").text().trim();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.news_detail_content_wrap").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("h1.news_detail_title").first();
