package com.bidizhaobiao.data.Crawl.service.impl.DS_19421;
 ...
 * 原网站：http://kjc.my.gov.cn/gggs/index.html
 * 主页：http://kjc.my.gov.cn
 **/
@Service
public class DS_19421_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    //列表界面
    public String listUrl = "http://kjc.my.gov.cn/gggs/index.html";
    //域名
    public String baseUrl = "http://kjc.my.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "19421";
    // 网站名称
    public String sourceName = "中国（绵阳）科技城";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&pageIndex=") || url.contains("index.html")) {
                ...
                Elements listElement = doc.select("ul.doc_list.list-4722361 li.odd");
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select(".wztit").first();
