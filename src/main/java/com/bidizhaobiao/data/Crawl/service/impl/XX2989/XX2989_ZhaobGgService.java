...
@Service
public class XX2989_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://caigou.peizheng.edu.cn/cat.php?id=3&page=0";
    ...
    // 站源类型
    public String taskType = "caigou_peizheng_edu_cn_zbgg_4";
    // 站源名称
    public String taskName = "广东培正学院采购中心-招标公告";
    // 抓取网站的相关配置，包括：编码、抓取间隔、重试次数
    Site site = Site.me().setCycleRetryTimes(2).setTimeOut(30000).setSleepTime(20);
    // 是否需要入广联达
    public boolean isNeedInsertGonggxinxi = true;
    // 信息源

    public Site getSite() {
        return this.site.addHeader("Referer", "http://caigou.peizheng.edu.cn/cat.php?id=3")
