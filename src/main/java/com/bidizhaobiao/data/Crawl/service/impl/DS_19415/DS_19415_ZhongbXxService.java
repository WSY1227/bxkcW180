package com.bidizhaobiao.data.Crawl.service.impl.DS_19415;
 ...
 * 原网站：http://canl.tongliao.gov.cn/shicl/tzgg/list.shtml
 * 主页：http://canl.tongliao.gov.cn/
 **/
@Service
public class DS_19415_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    //列表界面
    public String listUrl = "http://canl.tongliao.gov.cn/shicl/tzgg/list.shtml";
    //域名
    public String baseUrl = "http://canl.tongliao.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "19415";
    // 网站名称
    public String sourceName = "通辽市残疾人联合会";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select(".lm_list>li");
...
//                }
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select(".main.xwcontent .list").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select(".title>span").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        titleElement.remove();
                        contentElement.select(".pagenav").remove();
