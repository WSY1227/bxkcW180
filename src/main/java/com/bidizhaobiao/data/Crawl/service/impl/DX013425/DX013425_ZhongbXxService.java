package com.bidizhaobiao.data.Crawl.service.impl.DX013425;
 ...
 * 原网站：http://www.hngk.ha.cn/index.php?m=content&c=index&a=lists&catid=43
 * 主页：http://www.hngk.ha.cn
 **/
@Service
public class DX013425_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hngk.ha.cn/index.php?m=content&c=index&a=lists&catid=43&page=1";
    public String baseUrl = "http://www.hngk.ha.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013425";
    // 网站名称
    public String sourceName = "河南省国有资产控股运营集团有限公司";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select(".xwright>ul>li>a");
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("p.wzxq_bt").first();
