 ...
 * 程序员：许广衡
 * 日期：2020-10-29
 * 原网站：http://ztb.bnuz.edu.cn/xmtz_zbdy.htm
 * 主页：http://www.bnuz.edu.cn/
 **/
@Service
public class XX0319_ZhaobDyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.baidu.com/?wd=http://ztb.bnuz.edu.cn/xmtz_zbdy.htm";
        ...
        try {
            ...
            if (url.contains("xmtz_zbdy")) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    page.addTargetRequest(listUrl.replace("xmtz_zbdy", "xmtz_zbdy/" + (serviceContext.getMaxPage() - index + 1)));
                }
            } else {
