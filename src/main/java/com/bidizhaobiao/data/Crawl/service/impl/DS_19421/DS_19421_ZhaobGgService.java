 ...
 **/
@Service
public class DS_19421_ZhaobGgService extends SpiderService implements PageProcessor {
            ...
            if (url.contains("&pageIndex=") || url.contains("index.html")) {
                ...
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(element.select(".right.date").first().text());
                        if (dateMat.find()) {
