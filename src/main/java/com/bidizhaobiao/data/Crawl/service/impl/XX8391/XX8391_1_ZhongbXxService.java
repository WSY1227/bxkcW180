package com.bidizhaobiao.data.Crawl.service.impl.XX8391;
 ...
 * 原网站：http://www.hnczs-swz.edu.cn/Category_32/Index.aspx
 * 主页：http://www.hnczs-swz.edu.cn
 **/
@Service
public class XX8391_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hnczs-swz.edu.cn/Category_32/Index.aspx";
    public String baseUrl = "http://www.hnczs-swz.edu.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8391-1";
    // 网站名称
    public String sourceName = "郴州市第十五中学";
    // 信息源
    ...
    // 设置城市
    public String city = "郴州";
    // 设置县
    public String district = "北湖";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/Index")) {
                ...
                Elements listElement = doc.select("ul.topicList li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.article_content").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.article_contentT").first();
                        if (titleElement != null) {
                            titleElement.select(".article_info").remove();
