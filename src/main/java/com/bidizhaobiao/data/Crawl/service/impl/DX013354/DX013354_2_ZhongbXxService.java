package com.bidizhaobiao.data.Crawl.service.impl.DX013354;
 ...
 * 原网站：https://pms.hnchasing.com/cqgg/index.jhtml
 * 主页：https://pms.hnchasing.com
 **/
@Service
public class DX013354_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://pms.hnchasing.com/cqgg/index.jhtml";
    public String baseUrl = "https://pms.hnchasing.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013354-2";
    // 网站名称
    public String sourceName = "湖南财信金融控股集团有限公司-采购管理系统";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.contains("/index")) {
                ...
                Elements listElement = doc.select(".List2.Top10>ul>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.Padding10").first();
