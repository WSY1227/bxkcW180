package com.bidizhaobiao.data.Crawl.service.impl.Y04428;
 ...
 * 原网站：https://www.shouer.com.cn/notice.html
 * 主页：https://www.shouer.com.cn
 **/
@Service
public class Y04428_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.shouer.com.cn/notice.html";
    public String baseUrl = "https://www.shouer.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04428";
    // 网站名称
    public String sourceName = "首都儿科研究所";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (!url.contains("detail")) {
                ...
                Elements listElement = doc.select("div.list>.li");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.article1>.block").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select(".t.f28").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select(".p.f16").remove();
