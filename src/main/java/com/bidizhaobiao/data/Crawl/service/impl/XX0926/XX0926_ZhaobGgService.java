...
@Service
public class XX0926_ZhaobGgService extends SpiderService implements PageProcessor {
				...
				if (list.size() > 0) {
					for (int i = 0; i < list.size(); i++) {
						...
						if (!CheckProclamationUtil.isProclamationValuable(title,
								new String[] { "项目", "改造", "设计", "变更", "更正", "购买", "租赁", "购置", "招标", "采购", "询价", "竞标",
										"竞价", "竞谈", "竞拍", "竞卖", "竞买", "竞投", "竞租", "比选", "比价", "竞争性", "谈判", "磋商", "投标",
										"邀标", "议标", "议价", "单一来源", "遴选", "标段", "明标", "明投", "出让", "转让", "拍卖", "招租", "预审",
										"发包", "开标", "答疑", "补遗", "澄清", "挂牌" })) {
							continue;
						}
