 ...
 * 原网站：http://www.lw.gov.cn/gzlwhlj/gkmlpt/index
 * 主页：http://www.lw.gov.cn
 **/

@Service("QX_01472_25_ZhaobGgService")
public class QX_01472_25_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://www.lw.gov.cn/gzlwhlj/gkmlpt/api/all/0?page=1&sid=200203";

    public String baseUrl = "http://www.lw.gov.cn";
    // 网站编号
    public String sourceNum = "01472-25";
    // 网站名称
            ...
            if (url.contains("page")) {
                ...
                if (articles.length() > 0) {
                    for (int i = 0; i < articles.length(); i++) {
                        ...
                        String keys = "征选、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌";
