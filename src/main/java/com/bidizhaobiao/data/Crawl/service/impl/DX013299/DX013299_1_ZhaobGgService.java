 ...
 * 原网站：http://www.kmjtjt.net/list/cnIndex/1/31/auto/20/0.html
 * 主页：http://www.kmjtjt.net
 **/
@Service
public class DX013299_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.kmjtjt.net/list/cnIndex/1/31/auto/20/0.html";
    public String baseUrl = "http://www.kmjtjt.net";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013299-1";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (!url.contains("/view/")) {
                ...
                Elements listElement = doc.select(".textList2>dd");
                ...
                if (nextPage != null && nextPage.attr("href").contains("/toPage?") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Elements articleTime = contentElement.select(".articleTime");
                        Matcher dateMat = datePat.matcher(articleTime.text());
                        if (dateMat.find()) {
