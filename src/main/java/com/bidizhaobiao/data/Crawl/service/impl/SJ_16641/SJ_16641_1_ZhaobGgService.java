package com.bidizhaobiao.data.Crawl.service.impl.SJ_16641;
...
/**
 * 程序员:邓敏 日期：2021-06-09
 * 原网站：http://www.njbona.com.cn/news/3.html
 * 主页：http://www.njbona.com.cn
 **/
@Service
public class SJ_16641_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.njbona.com.cn/news/3/0.html";
    public String baseUrl = "http://www.njbona.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "16641-1";
    // 网站名称
    public String sourceName = "南京博纳招标代理有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("news")) {
                ...
                Elements listElement = doc.select(".content_nei li:has(a)");
                ...
                if (nextPage != null && nextPage.attr("href").contains("news") && serviceContext.isNeedCrawl()) {
                    page.addTargetRequest(listUrl.replace("3/0","3/"+serviceContext.getPageNum()));
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select(".pro_con").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("h3").first();
