 ...
 * 原网站：http://www.kmjtjt.net/list/cnIndex/1/45/auto/20/0.html
 * 主页：http://www.kmjtjt.net
 **/
@Service
public class DX013299_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.kmjtjt.net/list/cnIndex/1/45/auto/20/0.html";
    public String baseUrl = "http://www.kmjtjt.net";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013299-2";
    // 网站名称
