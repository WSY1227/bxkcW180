package com.bidizhaobiao.data.Crawl.service.impl.DS_24915;
 ...
 * 原网站：http://www.btdzj.org.cn/tzgg.jhtml
 * 主页：http://www.btdzj.org.cn
 **/
@Service
public class DS_24915_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.btdzj.org.cn/tzgg.jhtml";
    public String baseUrl = "http://www.btdzj.org.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24915";
    // 网站名称
    public String sourceName = "包头市地震局";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (!url.contains("/tzgg/")) {
                ...
                Elements listElement = doc.select("ul.list_r_list_ul>li:has(a)");
                ...
                Element nextPage = doc.select("a.next-page").first();
                if (nextPage != null && nextPage.attr("onclick").contains("tzgg_") && serviceContext.isNeedCrawl()) {
                    String href = baseUrl + "/" + nextPage.attr("onclick").replaceAll(".*'(.*?)'.*", "$1");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.detail_main").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("p.detail_info").remove();
