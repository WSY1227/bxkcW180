package com.bidizhaobiao.data.Crawl.service.impl.Y04777;
 ...
 * 原网站：http://zyszyyy.cn/notice_news.asp
 * 主页：http://zyszyyy.cn
 **/
@Service("Y04777_1_ZhongbXxService")
public class Y04777_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://zyszyyy.cn/notice_news.asp?page=1&bigclass=";
    public String baseUrl = "http://zyszyyy.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04777-1";
    // 网站名称
    public String sourceName = "招远市中医医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?page=")) {
                ...
                Elements listElement = doc.select(".STYLE24>a");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div[style='line-height:26px; font-size:16px;color:#505050']").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select(".STYLE36").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        Element timeElement = doc.select(".xiaxuxian.STYLE20").first();
                        if (timeElement != null) {
