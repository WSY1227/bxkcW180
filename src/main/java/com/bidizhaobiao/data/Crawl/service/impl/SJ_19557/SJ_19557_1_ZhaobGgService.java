 ...
 **/
@Service
public class SJ_19557_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    //列表界面
    public String listUrl = "http://gdzzxmgl.com/portal/list/index.html?id=11";
    //域名
    public String baseUrl = "http://gdzzxmgl.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "19557-1";
    // 网站名称
