package com.bidizhaobiao.data.Crawl.service.impl.Y04824;
 ...
 * 原网站：http://www.jdzdsrmyy.com/html/list_1472.html
 * 主页：http://www.jdzdsrmyy.com
 **/
@Service("Y04824_1_ZhongbXxService")
public class Y04824_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.jdzdsrmyy.com/html/list_1472.html";
    public String baseUrl = "http://www.jdzdsrmyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04824-1";
    // 网站名称
    public String sourceName = "景德镇市第四人民医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/list_1472")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select(".news>table tr:has(a)");
                ...
                Element nextPage = doc.select("#fenye a:contains(下一页)").first();
                if (nextPage != null && nextPage.attr("href").contains("/list_1472") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.newscontent").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("div.left01>h2").first();
