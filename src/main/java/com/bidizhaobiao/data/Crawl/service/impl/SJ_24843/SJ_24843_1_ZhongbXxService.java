package com.bidizhaobiao.data.Crawl.service.impl.SJ_24843;
 ...
 * 原网站：https://www.ssgj99.cn/article_zcpt.html
 * 主页：https://www.ssgj99.cn
 **/
@Service
public class SJ_24843_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.ssgj99.cn/article_zcpt.html";
    public String baseUrl = "https://www.ssgj99.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24843-1";
    // 网站名称
    public String sourceName = "首盛国际工程咨询集团有限公司";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/article_zcpt")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select(".p102-pros-1-list>dl");
                ...
                if (nextPage != null && nextPage.attr("href").contains("/article_zcpt") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.news_information_con").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select(".news_title.clearfix>h2").first();
