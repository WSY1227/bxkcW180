package com.bidizhaobiao.data.Crawl.service.impl.DX013421;
 ...
 * 原网站：http://www.wfsgt.com/news/152.html
 * 主页：http://www.wfsgt.com
 **/
@Service
public class DX013421_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.wfsgt.com/news/152.html?catId=152&page=1";
    public String baseUrl = "http://www.wfsgt.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013421";
    // 网站名称
    public String sourceName = "潍坊市国投公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select(".three-box>li>a");
                if (listElement.size() > 0) {
                    ...
                    for (Element a : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(a.select(".time").text());
                        if (dateMat.find()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div#details-con").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.con-title").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.con-time").remove();
