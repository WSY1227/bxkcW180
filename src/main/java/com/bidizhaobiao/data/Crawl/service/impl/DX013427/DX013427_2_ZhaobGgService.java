 ...
 * 原网站：http://dedaluqiao.com/list-27.html
 * 主页：http://dedaluqiao.com
 **/
@Service
public class DX013427_2_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://dedaluqiao.com/list-27.html";
    public String baseUrl = "http://dedaluqiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013427-2";
    // 网站名称
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/list-27")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("ul#list>li>a");
                ...
                if (nextPage != null && nextPage.attr("href").contains("/list-27") && serviceContext.isNeedCrawl()) {
