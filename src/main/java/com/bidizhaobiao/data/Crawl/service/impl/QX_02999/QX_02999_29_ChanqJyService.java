 ...
 * 原网站：http://ggzyjy.weihai.cn/rongcheng/jyxx/003004/003004002/transInfo.html
 * 主页：http://ggzyjy.weihai.cn
 **/

@Service("QX_02999_29_ChanqJyService")
public class QX_02999_29_ChanqJyService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "02999-29";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("page=")) {
                ...
                if(title.length()>255){
                   title= title.substring(0,99)+"等成交公告";
                }
    ...
    public Request getRequest(String link, int pageIndex) {
        ...
        map.put("params", "{\"siteGuid\":\"3f183aed-2171-4692-8cfc-ea14fe07cc96\",\"categoryNum\":\"003004002\",\"kw\":\"\",\"startDate\":\"\",\"endDate\":\"\",\"pageIndex\":" + (pageIndex - 1) + ",\"pageSize\":12,\"area\":\"\"}");
