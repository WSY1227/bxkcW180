package com.bidizhaobiao.data.Crawl.service.impl.DS_24910;
 ...
 * 原网站：http://slj.yzcity.gov.cn/slj/0201/list2.shtml
 * 主页：http://slj.yzcity.gov.cn
 **/
@Service
public class DS_24910_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://slj.yzcity.gov.cn/slj/0201/list2.shtml";
    public String baseUrl = "http://slj.yzcity.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24910";
    // 网站名称
    public String sourceName = "永州水利网";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/list2")) {
                ...
                Elements listElement = doc.select("ul.news_list>li:has(a)");
                ...
                if (serviceContext.getPageNum() == 1) {
                    ...
                    Matcher matcher = compile.matcher(doc.select(".news_list>script").get(1).html());
                    if (matcher.find()) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    String href = listUrl.replace("list2", "list2_" + serviceContext.getPageNum());
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.ny_c").first();
                    if (contentElement != null) {
                        ...
                        for (Element a : aList) {
                            ...
                            if (href.contains(".doc") || href.contains(".pdf") || href.contains(".zip") || href.contains(".xls") && a.text().equals(title)) {
                                a.text("附件下载：" + a.text());
                            }
                        ...
                        Element titleElement = contentElement.select(".meta>h1").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }

                        contentElement.select(".n_header").remove();
                        contentElement.select("div.meta").remove();
