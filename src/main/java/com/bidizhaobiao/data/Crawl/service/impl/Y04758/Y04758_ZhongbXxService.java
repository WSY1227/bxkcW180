package com.bidizhaobiao.data.Crawl.service.impl.Y04758;
 ...
 * 原网站：https://www.cqhcqzyy.com/html/yydt/zbcg/
 * 主页：https://www.cqhcqzyy.com
 **/
@Service("Y04758_ZhongbXxService")
public class Y04758_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.cqhcqzyy.com/html/yydt/zbcg/";
    public String baseUrl = "https://www.cqhcqzyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04758";
    // 网站名称
    public String sourceName = "重庆市合川区中医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/zbcg")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("ul.clearfix>li>a");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.art1").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.hd h2").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.hd p").remove();
