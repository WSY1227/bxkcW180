package com.bidizhaobiao.data.Crawl.service.impl.DS_24779;
 ...
 * 原网站：http://newivc.jaas.ac.cn/xww/tzgg/index.html
 * 主页：http://newivc.jaas.ac.cn
 **/
@Service("DS_24779_ZhongbXxService")
public class DS_24779_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://newivc.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?parseType=bulidstatic&webId=fe0ba29f1ba04474abae7550936cb65a&tplSetId=9ad8e0f625c24ab2b9b4cd657b438221&pageType=column&tagId=%E4%BF%A1%E6%81%AFlist&editType=null&pageId=511eff0cd07d4eb18a5bf916c45f71a0";
    public String baseUrl = "http://newivc.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24779";
    // 网站名称
    public String sourceName = "江苏省农业科学院蔬菜研究所";
    // 信息源
