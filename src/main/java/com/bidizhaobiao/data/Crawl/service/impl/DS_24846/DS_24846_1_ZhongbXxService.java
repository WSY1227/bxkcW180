 ...
 * 原网站：https://csglxzzfj.chizhou.gov.cn/OpennessContent/showList/55/6208/page_1.html
 * 主页：https://csglxzzfj.chizhou.gov.cn
 **/
@Service
public class DS_24846_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://csglxzzfj.chizhou.gov.cn/OpennessContent/showList/55/6208/page_1.html";
    public String baseUrl = "https://csglxzzfj.chizhou.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24846-1";
    // 网站名称
