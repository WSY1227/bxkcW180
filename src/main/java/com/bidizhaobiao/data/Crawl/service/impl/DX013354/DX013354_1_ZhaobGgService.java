 ...
 * 原网站：https://pms.hnchasing.com/cggg/index.jhtml
 * 主页：https://pms.hnchasing.com
 **/
@Service
public class DX013354_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://pms.hnchasing.com/cggg/index.jhtml";
    public String baseUrl = "https://pms.hnchasing.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013354-1";
    // 网站名称
