package com.bidizhaobiao.data.Crawl.service.impl.DS_11255;
...
/**
 * 程序员：陆浩锐 日期：2020-09-15
 * 原网站：http://mzj.wuhan.gov.cn/zwgk_918/fdzdgk/qtzdgknr/cgxx/
 * 主页：http://mzj.wuhan.gov.cn/
 **/
@Service
public class DS_11255_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://mzj.wuhan.gov.cn/zwgk_918/fdzdgk/qtzdgknr/cgxx/";
    public String baseUrl = "http://mzj.wuhan.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "11255";
    // 网站名称
    public String sourceName = "武汉市民政局";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                Elements listElement = doc.select("ul.info-list li:has(a)");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        Element a = element.select("a").first();
                        String link = a.attr("href").trim();
                        link = url.substring(0, url.lastIndexOf("/")) + link.substring(link.lastIndexOf("../") + 2);
                        String id = link.substring(link.lastIndexOf(".cn/") + 3);
                        String date = "";
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.article-box").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("div.article h2").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.article-code").remove();
