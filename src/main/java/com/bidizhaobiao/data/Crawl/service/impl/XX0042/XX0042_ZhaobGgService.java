...
@Service
public class XX0042_ZhaobGgService extends SpiderService implements PageProcessor {
            ...
            if (!url.contains("info")) {
                ...
                if (lis.size() > 0) {
                    for (Element li : lis) {
                        ...
                        String key = "购置、设备、维修、邀请、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌";
                ...
                String key = "招标、购置、询价、邀请、采购、竞争性、磋商、谈判、比选、维修、项目、工程";
                String[] rules = key.split("、");
                if (!CheckProclamationUtil.isProclamationValuable(detailTitle, rules)) {
                    return;
                }
