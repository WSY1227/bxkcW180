 ...
 * 程序员：邱文杰
 * 日期：2021-04-16
 * 原网站：http://www.bjztc.com/notice/other
 * 主页：http://www.bjztc.com/
 */

@Service("GJ_07280_2_ZhongbXxService")
public class GJ_07280_2_ZhongbXxService extends SpiderService implements PageProcessor {

    public  Spider spider = null;

    public  String listUrl = "http://www.bjztc.com/notice/other";
    ...
    // 网站编号
    public String sourceNum = "07280-2";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(1000);
            // 判断是否是翻页连接
            if (url.equals("http://www.bjztc.com/notice/other")) {
