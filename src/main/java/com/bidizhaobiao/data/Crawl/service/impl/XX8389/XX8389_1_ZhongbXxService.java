package com.bidizhaobiao.data.Crawl.service.impl.XX8389;
 ...
 * 原网站：http://www.hs14z.net/tongzhi/
 * 主页：http://www.hs14z.net
 **/
@Service
public class XX8389_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hs14z.net/tongzhi/list_47_1.html";
    public String baseUrl = "http://www.hs14z.net";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8389-1";
    // 网站名称
    public String sourceName = "衡水市第十四中学";
    // 信息源
    ...
    // 设置城市
    public String city = "衡水";
    // 设置县
    public String district = "桃城";
        ...
        try {
            ...
            if (url.contains("/list")) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.press_message").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("h1.contitle").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.conAuthor").remove();
                        contentElement.select("div[style=padding-left:10px]").remove();
