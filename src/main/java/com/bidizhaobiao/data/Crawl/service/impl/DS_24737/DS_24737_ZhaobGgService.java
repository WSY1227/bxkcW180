package com.bidizhaobiao.data.Crawl.service.impl.DS_24737;
 ...
 * 原网站：http://rsj.longyan.gov.cn/zwgk/gsgg/
 * 主页：http://rsj.longyan.gov.cn
 **/
@Service
public class DS_24737_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://rsj.longyan.gov.cn/zwgk/gsgg/index.htm";
    public String baseUrl = "http://rsj.longyan.gov.cn/zwgk/gsgg/";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24737";
    // 网站名称
    public String sourceName = "龙岩市人力资源和社会保障局";
    // 信息源
        ...
        try {
            ...
            if (url.contains("/index")) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("td.k>table").first();
