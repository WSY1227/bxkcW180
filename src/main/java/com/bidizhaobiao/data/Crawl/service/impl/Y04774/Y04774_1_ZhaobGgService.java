package com.bidizhaobiao.data.Crawl.service.impl.Y04774;
 ...
 * 原网站：http://www.shsdfyyjayy.com/index/index/notice.html
 * 主页：http://www.shsdfyyjayy.com
 **/
@Service("Y04774_1_ZhaobGgService")
public class Y04774_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.shsdfyyjayy.com/index/index/notice.html";
    public String baseUrl = "http://www.shsdfyyjayy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04774-1";
    // 网站名称
    public String sourceName = "上海市东方医院吉安医院";
    // 信息源
    ...
    // 设置城市
    public String city = "吉安";
    // 设置县
    public String district = "吉州";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select(".News_list>ul>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.mianContent").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("h5.Info_title").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select(".Info_time").remove();
                        contentElement.select(".Info_back").remove();
                        contentElement.select(".Info_page").remove();
