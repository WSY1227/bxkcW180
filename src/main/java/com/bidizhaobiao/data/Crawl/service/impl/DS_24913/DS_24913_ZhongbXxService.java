package com.bidizhaobiao.data.Crawl.service.impl.DS_24913;
 ...
 * 原网站：http://dzj.lanzhou.gov.cn/col/col5266/index.html
 * 主页：http://dzj.lanzhou.gov.cn
 **/
@Service
public class DS_24913_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://dzj.lanzhou.gov.cn/module/web/jpage/dataproxy.jsp?startrecord=1&endrecord=45&perpage=15";
    public String baseUrl = "http://dzj.lanzhou.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24913";
    // 网站名称
    public String sourceName = "兰州市地震局";
    // 信息源
    ...
    public Request getListRequest(int startrecord, int endrecord) {
        ...
        params.put("webid", "56");
        params.put("path", "/");
        params.put("columnid", "5266");
        params.put("sourceContentType", "1");
        params.put("unitid", "107058");
        params.put("webname", "兰州市地震局");
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&perpage=")) {
                ...
                Elements listElement = doc.select("li>a");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.nr_xx").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.info.clearbox").remove();
                        contentElement.select("script").remove();
                        contentElement.select("style").remove();
                        content = contentElement.outerHtml();
                    } else if (doc.select("#Zoom") != null) {
                        contentElement = doc.select("#Zoom").first();
                        Elements aList = contentElement.select("a");
                        for (Element a : aList) {
                            String href = a.attr("href");
                            a.attr("rel", "noreferrer");
                        ...
                        Element titleElement = doc.select("td>span>center").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        if (!CheckProclamationUtil.isProclamationValuable(title)) {
