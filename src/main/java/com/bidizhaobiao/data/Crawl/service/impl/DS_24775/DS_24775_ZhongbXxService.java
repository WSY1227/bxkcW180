package com.bidizhaobiao.data.Crawl.service.impl.DS_24775;
 ...
 * 原网站：http://www.scwsrc.com/news
 * 主页：http://www.scwsrc.com
 **/
@Service
public class DS_24775_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.scwsrc.com/news?pageindex=1";
    public String baseUrl = "http://www.scwsrc.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24775";
    // 网站名称
    public String sourceName = "四川省卫生健康人才服务管理平台";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?pageindex=")) {
                ...
                Elements listElement = doc.select("#newslist>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.newsinfo").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.title.btline").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.subtit.c").remove();
