package com.bidizhaobiao.data.Crawl.service.impl.Y04079;
...
/**
 * 程序员：白嘉全 日期：2021-11-04
 * 原网站：http://www.czszyyjsfsyy.cn/index.php?p=news_list&lanmu=13
 * 主页：http://www.czszyyjsfsyy.cn
 **/
@Service("Y04079_ZhongbXxService")
public class Y04079_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public boolean isNeedSaveFileAddSSL = true;
    public String listUrl = "http://www.czszyyjsfsyy.cn/index.php?p=news_list&lanmu=13&page=1";
    public String baseUrl = "http://www.czszyyjsfsyy.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "Y04079";
    // 网站名称
    public String sourceName = "长治市中医研究所附属医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("page")) {
                ...
                Elements listElement = doc.select("ul.am-list li");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("article.am-article").first();
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.am-article-hd h1").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.am-article-hd").remove();
                        contentElement.select("div.am-article-hd").remove();
