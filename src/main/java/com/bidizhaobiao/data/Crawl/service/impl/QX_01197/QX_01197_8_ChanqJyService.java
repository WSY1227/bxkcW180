...
/**
 * 程序员：唐家逸 日期：2021-11-01 原网站：http://ggzy.np.gov.cn/sc/gycq/012004/
 * 主页：http://ggzy.np.gov.cn/sc/
 **/

@Service
public class QX_01197_8_ChanqJyService extends SpiderService implements PageProcessor {

	public Spider spider = null;

	// 列表数据不及时
	public String listUrl = "http://ggzy.np.gov.cn/sc/gycq/012004/";
	public String baseUrl = "http://ggzy.np.gov.cn";
	// 网站编号
	public String sourceNum = "01197-8";
	// 网站名称
	...
	public void process(Page page) {
		...
		try {
			...
			if (url.equals(listUrl)) {
				...
				Element tab = doc.select("ul[class=content-list clearfix]").first();
				if (tab != null) {
