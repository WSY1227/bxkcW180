package com.bidizhaobiao.data.Crawl.service.impl.XX8386;
 ...
 * 原网站：http://www.zb11.net/categories/46
 * 主页：http://www.zb11.net
 **/
@Service
public class XX8386_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.zb11.net/categories/46?page=1";
    public String baseUrl = "http://www.zb11.net";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8386-1";
    // 网站名称
    public String sourceName = "淄博市第十一中学";
    // 信息源
    ...
    // 设置城市
    public String city = "淄博";
    // 设置县
    public String district = "张店";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?page=")) {
                ...
                Elements listElement = doc.select(".content-content>div>.media-body.content-p:has(a)");
                ...
                Element nextPage = doc.select("ul.pagination a:contains(»)").first();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.content-content").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("p.text-center").remove();
