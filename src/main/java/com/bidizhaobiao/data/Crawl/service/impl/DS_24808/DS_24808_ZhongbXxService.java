package com.bidizhaobiao.data.Crawl.service.impl.DS_24808;
 ...
 * 原网站：http://njnks.jaas.ac.cn/tzgg/index.html
 * 主页：http://njnks.jaas.ac.cn
 **/
@Service
public class DS_24808_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://njnks.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=80c14af4edcb4f599df74cc18d0e1824&pageId=164ba3439e2c4d099dd29c31ed69a80d&parseType=bulidstatic&pageType=column&tagId=%E4%BF%A1%E6%81%AFlist&tplSetId=49a3772601d9439faa36b20cab86c9a7&paramJson=%7B%22pageNo%22%3A1%2C%22pageSize%22%3A15%7D";
    public String baseUrl = "http://njnks.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24808";
    // 网站名称
    public String sourceName = "江苏丘陵地区南京农科所";
    // 信息源
        ...
        try {
            ...
            if (url.contains("/api-gateway")) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    String href = "http://njnks.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=80c14af4edcb4f599df74cc18d0e1824&pageId=164ba3439e2c4d099dd29c31ed69a80d&parseType=bulidstatic&pageType=column&tagId=%E4%BF%A1%E6%81%AFlist&tplSetId=49a3772601d9439faa36b20cab86c9a7&paramJson=%7B%22pageNo%22%3A" + serviceContext.getPageNum() + "%2C%22pageSize%22%3A15%7D";
