package com.bidizhaobiao.data.Crawl.service.impl.Y04748;
 ...
 **/
@Service("Y04748_1_ZhongbXxService")
public class Y04748_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.plxrmyy.com/col.jsp?id=131";
    public String baseUrl = "http://www.plxrmyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04748-1";
    // 网站名称
    public String sourceName = "平乐县人民医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/col.jsp")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("div.m_news_content>.m_news_info");
