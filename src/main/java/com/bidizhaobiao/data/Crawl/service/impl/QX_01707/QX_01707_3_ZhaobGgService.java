 ...
 * 原网站：http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=400&jsgc=&zfcg=0100000&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=jygg
 * 主页：http://ggzy.huangzhou.gov.cn
 **/

@Service("QX_01707_3_ZhaobGgService")
public class QX_01707_3_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=400&jsgc=&zfcg=0100000&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=jygg&page=1";
            ...
            if (url.contains("page=")) {
                ...
                if (conTag != null) {
                    ...
                    if (matcher.find()) {
                        ...
                        link = "http://ggzy.huangzhou.gov.cn/ceinwz/Hyzq/" + link;
                        content = "<div><a href=\"" + link + "\">点击查看</a></div>";
                    }
                }
