...
/**
 * 程序员：唐家逸 日期：2021-10-22 原网站：首页/建设工程/补充通知（仅抓取首页标题） 主页：http://ggzy.np.gov.cn/sc/
 **/

@Service
public class  QX_01197_4_GonggBgService extends SpiderService implements PageProcessor {
	...
	// 网站编号
	public String sourceNum = "01197-4";
	// 网站名称
	...
	public void process(Page page) {
		...
		try {
			...
			if (url.equals(listUrl)) {
				...
				Element tab = doc.select("div[id=jsgccon2] ul").first();
				if (tab != null) {
