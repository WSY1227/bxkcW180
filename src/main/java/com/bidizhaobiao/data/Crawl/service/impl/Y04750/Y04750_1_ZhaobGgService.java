package com.bidizhaobiao.data.Crawl.service.impl.Y04750;
...
public class Y04750_1_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    public String baseUrl = "http://www.ycsthqrmyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04750-1";
    // 网站名称
    public String sourceName = "盐城市亭湖区人民医院";
    // 信息源
...
//                        branch.setDate(date);
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.tc-box.article-box").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.article-infobox").remove();
                    ...
                    String date = "";
                    Matcher dateMat = datePat.matcher(content);
                    if (dateMat.find()) {
