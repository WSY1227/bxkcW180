package com.bidizhaobiao.data.Crawl.service.impl.XX8345;
 ...
 * 原网站：https://wdsdx.whsu.edu.cn/tzgg.htm
 * 主页：https://wdsdx.whsu.edu.cn
 **/
@Service
public class XX8345_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://wdsdx.whsu.edu.cn/tzgg.htm";
    public String baseUrl = "https://wdsdx.whsu.edu.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8345-1";
    // 网站名称
    public String sourceName = "武当山国际武术学院";
    // 信息源
    ...
    // 设置城市
    public String city = "铜仁";
    // 设置县
    public String district = "江口";
            ...
            if (url.contains("/tzgg")) {
                ...
                if (listElement.size() > 0) {
                    ...
                    for (Element element : listElement) {
                        ...
                        if (title.contains("XX8345_1_ZhaobGgService")) continue;
                ...
                Element nextPage = doc.select(".p_next.p_fun a:contains(下页)").first();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.newsContent>form").first();
                    if (contentElement != null) {
                        ...
                        if (titleElement != null) {
                            contentElement.select(".messages").remove();
