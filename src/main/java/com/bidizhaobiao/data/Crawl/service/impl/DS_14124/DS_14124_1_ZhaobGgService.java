...
@Service("DS_14124_1_ZhaobGgService")
public class DS_14124_1_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "14124-1";
    // 网站名称
    ...
    public Request getListRequest(int pageIndex) {
        ...
        try {
            ...
            String json = "{\"portalBiddingType\":\"0\",\"tenderProjectType\":\"B\",\"page\":" + pageIndex + ",\"limit\":10,\"_t\":1609812204}";
