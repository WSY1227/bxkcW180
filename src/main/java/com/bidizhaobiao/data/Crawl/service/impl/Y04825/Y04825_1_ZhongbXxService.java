package com.bidizhaobiao.data.Crawl.service.impl.Y04825;
 ...
 * 原网站：http://www.yywrmyy.com/index.php?c=article&a=type&tid=22
 * 主页：http://www.yywrmyy.com
 **/
@Service("Y04825_1_ZhongbXxService")
public class Y04825_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.yywrmyy.com/index.php?c=article&a=type&tid=22&page=1";
    public String baseUrl = "http://www.yywrmyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04825-1";
    // 网站名称
    public String sourceName = "益阳市第五人民医院";
    // 信息源
    ...
    // 设置城市
    public String city = "益阳";
    // 设置县
    public String district = "赫山";
            ...
            if (url.contains("&page=")) {
                ...
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(element.select(".time").text());
                        if (dateMat.find()) {
                ...
                if (serviceContext.getPageNum() == 1) {
                    ...
                    String href = doc.select(".list_page.page_group a:contains(尾页)").first().attr("href");
                    Matcher matcher = compile.matcher(doc.select(".list_page.page_group a:contains(尾页)").first().attr("href"));
                    while (matcher.find()) {
