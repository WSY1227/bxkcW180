 ...
 * 程序员：邱文杰
 * 日期：2021-04-16
 * 原网站：http://www.bjztc.com/notice/result
 * 主页：http://www.bjztc.com/
 */

@Service("GJ_07280_1_ZhongbXxService")
public class GJ_07280_1_ZhongbXxService extends SpiderService implements PageProcessor {

    public  Spider spider = null;

    public  String listUrl = "http://www.bjztc.com/notice/result?page=0";
        ...
        try {
            ...
            if (url.contains("page=")) {
                ...
                if (serviceContext.getPageNum() == 1) {
                    String pageCount = document.select("a:contains(尾页)").first().attr("href");
                    String pageReg = "page=(\\d{1,5})";
