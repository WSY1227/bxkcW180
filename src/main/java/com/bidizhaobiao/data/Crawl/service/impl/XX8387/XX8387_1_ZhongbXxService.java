package com.bidizhaobiao.data.Crawl.service.impl.XX8387;
 ...
 * 原网站：http://www.qzsyz.com/app/index.php?i=7&c=site&a=site&cid=7006
 * 主页：http://www.qzsyz.com
 **/
@Service
public class XX8387_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.qzsyz.com/app/index.php?i=7&c=site&a=site&cid=7006&page=1";
    public String baseUrl = "http://www.qzsyz.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8387-1";
    // 网站名称
    public String sourceName = "泉州第十一中学";
    // 信息源
    ...
    // 设置城市
    public String city = "泉州";
    // 设置县
    public String district = "洛江";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select("ul.rpost>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String date = "";
                    String content = "";
                    Element contentElement = doc.select("div.post").first();
                    if (contentElement != null) {
                        ...
                        Element timeElement = contentElement.select(".meta span").last();
                        if (timeElement != null) {
                        ...
                        contentElement.select(".meta").remove();
