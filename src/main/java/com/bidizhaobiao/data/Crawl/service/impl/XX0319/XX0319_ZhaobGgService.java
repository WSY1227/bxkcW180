...
/**
 * 程序员：许广衡 日期：2020-10-29
 * 原网站：http://ggzy.jz.gov.cn/jyxx/077002/077002001/listMore.html
 * 主页：http://ggzy.jz.gov.cn/
 **/

@Service
public class XX0319_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "https://www.baidu.com/?wd=http://ztb.bnuz.edu.cn/zbgg.htm";
        ...
        try {
            ...
            if (url.contains("zbgg")) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    page.addTargetRequest(listUrl.replace("zbgg", "zbgg/" + (serviceContext.getMaxPage() - index + 1)));
                }
            } else {
