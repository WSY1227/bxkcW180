package com.bidizhaobiao.data.Crawl.service.impl.DX011471;
 ...
 * 原网站：http://www.hsguaranty.cn/arts.php?classid=479
 * 主页：http://www.hsguaranty.cn
 **/
@Service
public class DX011471_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hsguaranty.cn/arts.php?classid=479&page=1";
    public String baseUrl = "http://www.hsguaranty.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX011471";
    // 网站名称
    public String sourceName = "黄石市融资担保集团有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select("div#op1 ul li:has(a)");
                if (listElement.size() > 0) {
                    String key = "邀请、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌";
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div#ShowArtOne").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div#title p").remove();
                        contentElement.select("ul#PreNext").remove();
