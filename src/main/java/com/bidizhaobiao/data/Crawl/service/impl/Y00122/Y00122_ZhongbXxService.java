package com.bidizhaobiao.data.Crawl.service.impl.Y00122;
...
/**
 * 程序员：周素茵 日期：2023-01-04
 * 原网站：http://www.jxsetyy.cn/list/16.html
 * 主页：http://www.jxsetyy.cn/
 **/
@Service
public class Y00122_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.jxsetyy.cn/list/16.html";
    public String baseUrl = "http://www.jxsetyy.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y00122";
    // 网站名称
    public String sourceName = "江西省儿童医院";
    // 信息源
