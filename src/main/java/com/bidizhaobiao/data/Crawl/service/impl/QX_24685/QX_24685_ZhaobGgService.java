package com.bidizhaobiao.data.Crawl.service.impl.QX_24685;
 ...
 * 原网站：http://zx.haian.gov.cn/zx/zxgg/
 * 主页：http://zx.haian.gov.cn
 **/
@Service
public class QX_24685_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://zx.haian.gov.cn/zx/zxgg/";
    public String baseUrl = "http://zx.haian.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24685";
    // 网站名称
    public String sourceName = "海安政协";
    // 信息源
    ...
    // 设置城市
    public String city = "南通";
    // 设置县
    public String district = "海安";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/zxgg")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("ul.infomore2>li");
                ...
                Element nextPage = doc.select("td.pageout:contains(下页)").first();
                if (nextPage != null && nextPage.attr("onclick").contains("/?Paging") && serviceContext.isNeedCrawl()) {
                    int pageNum = serviceContext.getPageNum();
                    String href = listUrl + "?Paging=" + (++pageNum);
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("#tblInfo").first();
                    if (contentElement != null) {
                        ...
                        Elements trs = contentElement.select("tr");
                        Element titleElement = trs.get(1);
