...
@Service("DS_14124_7_GonggBgService")
public class DS_14124_7_GonggBgService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "14124-7";
    // 网站名称
    ...
    public Request getListRequest(int pageIndex) {
        ...
        try {
            ...
            String json = "{\"portalBiddingType\":\"1\",\"tenderProjectType\":\"A\",\"page\":" + pageIndex + ",\"limit\":10,\"_t\":1609813775}";
