 ...
 * 原网站：http://www.lhsl.gov.cn/zwgk/zzbgg/index.html
 * 主页：http://www.lhsl.gov.cn
 **/

@Service
public class QX_02603_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://www.lhsl.gov.cn/zwgk/zzbgg/index.html";
            ...
            if (url.contains("index")) {
                ...
                if (lis.size() > 0) {
                    for (Element li : lis) {
                        ...
                        if(!link.contains("www.lhsl.gov.cn")){
                            continue;
                        }
                ...
                Element contentE = document.select("div.grid-little").first();
