package com.bidizhaobiao.data.Crawl.service.impl.DS_24911;
 ...
 * 原网站：https://eq.fy.gov.cn/content/channel/578498907f8b9a754a4905dd/
 * 主页：https://eq.fy.gov.cn
 **/
@Service
public class DS_24911_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://eq.fy.gov.cn/content/channel/578498907f8b9a754a4905dd/page-1/";
    public String baseUrl = "https://eq.fy.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24911";
    // 网站名称
    public String sourceName = "阜阳市地震局";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.contains("page-")) {
                ...
                Elements listElement = doc.select(".listright-box>ul>li:has(a)");
                if (listElement.size() > 0) {
                    String key = "询标、交易、机构、需求、废旧、废置、处置、报废、供应商、承销商、服务商、调研、优选、择选、择优、选取、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
                ...
                Element nextPage = doc.select("#page-list a:contains(下一页)").first();
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.u-funs").remove();
                        contentElement.select("div.wzewm").remove();
                        contentElement.select("div.m-btfuns").remove();
