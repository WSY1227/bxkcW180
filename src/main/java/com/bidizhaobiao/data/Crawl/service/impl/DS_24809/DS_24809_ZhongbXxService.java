package com.bidizhaobiao.data.Crawl.service.impl.DS_24809;
 ...
 * 原网站：http://xyz.jaas.ac.cn/tzgg/index.html
 * 主页：http://xyz.jaas.ac.cn
 **/
@Service
public class DS_24809_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://xyz.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=5900d81bc6b8490a88ddb89ebcd9421a&pageId=aeca77e4d8be4f81a060b80389acc70e&parseType=bulidstatic&pageType=column&tagId=%E5%BD%93%E5%89%8D%E6%A0%8F%E7%9B%AElist&tplSetId=4cf83ff73b714baf8bfc3982d14273cc&paramJson=%7B%22pageNo%22%3A1%2C%22pageSize%22%3A10%7D";
    public String baseUrl = "http://xyz.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24809";
    // 网站名称
    public String sourceName = "江苏新洋试验站";
    // 信息源
    ...
    Site site = Site.me().setCycleRetryTimes(2).setTimeOut(30000).setSleepTime(20).setSleepTime(20).setUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36 Edg/108.0.1462.76");
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/api-gateway")) {
                ...
                Elements listElement = doc.select(".page-content>.news-list-single");
                ...
                if (serviceContext.getPageNum() == 1) {
                    ...
                    serviceContext.setMaxPage(count / 10);
                    if (count % 10 != 0) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    String href = "http://xyz.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=5900d81bc6b8490a88ddb89ebcd9421a&pageId=aeca77e4d8be4f81a060b80389acc70e&parseType=bulidstatic&pageType=column&tagId=%E5%BD%93%E5%89%8D%E6%A0%8F%E7%9B%AElist&tplSetId=4cf83ff73b714baf8bfc3982d14273cc&paramJson=%7B%22pageNo%22%3A" + serviceContext.getPageNum() + "%2C%22pageSize%22%3A10%7D";
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.content-box").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.article-content-extend").remove();
