package com.bidizhaobiao.data.Crawl.service.impl.SJ_24917;
 ...
 * 原网站：http://www.gddzj.gov.cn/gddzj/zwgk92/cgzb/index.html
 * 主页：http://www.gddzj.gov.cn
 **/
@Service
public class SJ_24917_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.gddzj.gov.cn/gddzj/zwgk92/cgzb/27f6653b-1.html";
    public String baseUrl = "http://www.gddzj.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24917";
    // 网站名称
    public String sourceName = "广东省地震信息网";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("/27f6653b")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("ul.ind_ul>li:has(a)");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String title = a.select("a>p").text().trim();
                ...
                Element nextPage = doc.select(".easysite-page-wrap a:contains(下一页)").first();
                if (nextPage != null && nextPage.attr("tagname").contains("/gddzj") && serviceContext.isNeedCrawl()) {
                    String href = baseUrl + nextPage.attr("tagname").trim();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.pub_main.layout.article_view.video_view").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.top").first();
                        if (titleElement != null) {
                            titleElement.select("div").remove();
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.table").remove();
