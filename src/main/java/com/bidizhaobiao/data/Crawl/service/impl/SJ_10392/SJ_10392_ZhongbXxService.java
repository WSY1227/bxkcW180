...
@Service
public class SJ_10392_ZhongbXxService extends SpiderService implements PageProcessor {

	public  Spider spider = null;

	public  String listUrl = "http://www.hbznhd.com/solution.aspx?TypeId=62&FId=t25:62:25";
			...
			if (url.equals(listUrl)) {
				...
				if (list.size() > 0) {
					for (int i = 0; i < list.size(); i++) {
						...
						if(!a.hasAttr("title")&&title.equals("")){
							continue;
						}
