package com.bidizhaobiao.data.Crawl.service.impl.DS_08247;
...
@Service
public class DS_08247_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://nd.1203.org/1097/index.jhtml";
    public String baseUrl = "http://nd.1203.org";
    public Pattern p = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "08247";
    // 网站名称
    public String sourceName = "宁德市残疾人联合会";
    // 信息源
