package com.bidizhaobiao.data.Crawl.service.impl.DX013356;
 ...
 * 原网站：http://www.zjkgfz.com.cn/news/4
 * 主页：http://www.zjkgfz.com.cn
 **/
@Service
public class DX013356_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.zjkgfz.com.cn/news/4?page=1";
    public String baseUrl = "http://www.zjkgfz.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013356-1";
    // 网站名称
    public String sourceName = "张家口高速公路发展有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?page=")) {
                ...
                Elements listElement = doc.select(".n_box_zw>ul:has(a)");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Element timeElement = element.select("br").first();
                        Matcher dateMat = datePat.matcher(timeElement.nextSibling().toString() + "-" + timeElement.previousSibling().toString() + "-" + element.select("span").first().text());
                        if (dateMat.find()) {
                        ...
                        String title = a.select(".fr>h3").text().trim();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.n_box_info").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("biaoti").first();
