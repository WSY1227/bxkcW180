package com.bidizhaobiao.data.Crawl.service.impl.XX8344;
 ...
 * 原网站：http://www.sxyqtx.cn/index.php?p=news_list&lanmu=9
 * 主页：http://www.sxyqtx.cn
 **/
@Service
public class XX8344_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.sxyqtx.cn/index.php?p=news_list&lanmu=9";
    public String baseUrl = "http://www.sxyqtx.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8344-1";
    // 网站名称
    public String sourceName = "阳泉市体育运动学校";
    // 信息源
    ...
    // 设置城市
    public String city = "阳泉";
    // 设置县
    public String district = "郊区";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("?p=news_list")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select(".news_list>ul>li>a");
                if (listElement.size() > 0) {
                    ...
                    for (Element a : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher("20" + a.select(".nr").text());
                        if (dateMat.find()) {
                        ...
                        String title = a.select(".nl").text().trim();
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("center").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.from").remove();
