package com.bidizhaobiao.data.Crawl.service.impl.XX8421;
 ...
 * 原网站：http://www.as8z.cn/h-nl.html
 * 主页：http://www.as8z.cn
 **/
@Service
public class XX8421_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.as8z.cn/h-nl.html?m402pageno=1";
    public String baseUrl = "http://www.as8z.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8421-1";
    // 网站名称
    public String sourceName = "鞍山市第八中学";
    // 信息源
    ...
    // 设置城市
    public String city = "鞍山";
    // 设置县
    public String district = "立山";
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("?m402pageno")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("#newsList402 table");
                ...
                if (nextPage != null && nextPage.attr("href").contains("?m402pageno") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.newsDetail.newsDetailV2.m_newsdetail__align-0").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("h1.title").first();
