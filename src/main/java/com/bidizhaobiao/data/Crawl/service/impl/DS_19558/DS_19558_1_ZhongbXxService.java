 ...
 * 原网站：https://zhaoxing.info/category/tender-notice/
 * 主页：https://zhaoxing.info
 **/
@Service
public class DS_19558_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://zhaoxing.info/category/tender-notice/";
    public String baseUrl = "https://zhaoxing.info";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "19558-1";
    // 网站名称
