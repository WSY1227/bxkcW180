package com.bidizhaobiao.data.Crawl.service.impl.XX8371;
 ...
 * 原网站：http://www.sgssyzx.com/dwxxgk/jbqk/cgxx/
 * 主页：http://www.sgssyzx.com
 **/
@Service
public class XX8371_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.sgssyzx.com/dwxxgk/jbqk/cgxx/";
    public String baseUrl = "http://www.sgssyzx.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8371-1";
    // 网站名称
    public String sourceName = "寿光市实验中学";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select(".lmdh_list>ul>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.lmy_content_r").first();
