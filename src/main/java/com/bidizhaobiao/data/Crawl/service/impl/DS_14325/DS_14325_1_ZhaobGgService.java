package com.bidizhaobiao.data.Crawl.service.impl.DS_14325;
 ...
 * 原网站：http://zygh.czs.gov.cn/17840/17846/17852/index.htm
 * 主页：http://zygh.czs.gov.cn
 **/
@Service
public class DS_14325_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://zygh.czs.gov.cn/17840/17846/17852/index.htm";
    public String baseUrl = "http://zygh.czs.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "14325-1";
    // 网站名称
    public String sourceName = "郴州市自然资源和规划局";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/index")) {
                ...
                Elements listElement = doc.select("ul.clearfix.list-ul>li");
                if (listElement.size() > 0) {
                    String key = "邀请、代理、机构、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌";
                ...
                if (nextPage != null && nextPage.attr("href").contains("index") && !nextPage.attr("href").contains("index.jsp") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.arc").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select(".des").remove();
                        contentElement.select(".share").remove();
                        contentElement.select("#div_div").remove();
                        contentElement.select("#Canvas").remove();
