package com.bidizhaobiao.data.Crawl.service.impl.XX8373;
 ...
 * 原网站：http://yysyz.com.cn/44/
 * 主页：http://yysyz.com.cn
 **/
@Service
public class XX8373_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://yysyz.com.cn/44/";
    public String baseUrl = "http://yysyz.com.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8373-1";
    // 网站名称
    public String sourceName = "岳阳市第一中学";
    // 信息源
    ...
    // 设置城市
    public String city = "岳阳";
    // 设置县
    public String district = "岳阳楼";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (!url.contains(".html")) {
                ...
                Elements listElement = doc.select(".right-page .h-title");
                ...
                if (nextPage != null && nextPage.attr("href").contains("/node") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.wrapper.clearfix").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.wznr-mess").remove();
