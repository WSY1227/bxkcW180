 ...
 * 原网站：http://www.lw.gov.cn/lwzx/tzgg/index.html
 * 主页：http://www.lw.gov.cn/
 **/
@Service("QX_01472_ZhaobGgService")
public class QX_01472_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public String listUrl = "http://www.lw.gov.cn/lwzx/tzgg/index.html";
    public String baseUrl = "http://www.lw.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})([年/\\-.])(\\d{1,2})([月/\\-.])(\\d{1,2})");
    // 网站编号
    public String sourceNum = "01472";
    // 网站名称
        ...
        try {
            ...
            if (url.contains("index")) {
                ...
                if (listElement.size() > 0) {
                    String key = "服务、报名、邀请、定制、招募、询标、交易、机构、需求、废旧、废置、处置、报废、供应商、承销商、服务商、调研、优选、择选、择优、选取、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、遴选、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.content_article").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("h1.content_title").first();
