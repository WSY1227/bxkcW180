...
@Service("DS_14124_4_ZhaobGgService")
public class DS_14124_4_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "14124-4";
    // 网站名称
    ...
    public Request getListRequest(int pageIndex) {
        ...
        try {
            ...
            String json = "{\"portalBiddingType\":\"0\",\"tenderProjectType\":\"C\",\"page\":" + pageIndex + ",\"limit\":10,\"_t\":1609812204}";
