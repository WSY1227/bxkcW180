 ...
 * 原网站：http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=0&jsgc=0000010&zfcg=&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=nourl
 * 主页：http://ggzy.huangzhou.gov.cn
 **/

@Service("QX_01707_1_ZhongbXxService")
public class QX_01707_1_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=0&jsgc=0000010&zfcg=&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=nourl&page=1";
            ...
            if (url.contains("page=")) {
                ...
                if (trs.size() > 1) {
                    for (int i = 0; i < trs.size() - 1; i++) {
                        ...
                        String date = tr.select("span").last().previousElementSibling().text().trim();
