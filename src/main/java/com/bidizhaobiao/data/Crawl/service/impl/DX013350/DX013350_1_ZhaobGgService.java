package com.bidizhaobiao.data.Crawl.service.impl.DX013350;
 ...
 * 原网站：http://www.hiecc.cn/Col.asp?ChanId=4&ColId=37
 * 主页：http://www.hiecc.cn
 **/
@Service
public class DX013350_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hiecc.cn/Col.asp?ChanId=4&ColId=37&CaseId=4&page=1";
    public String baseUrl = "http://www.hiecc.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013350-1";
    // 网站名称
    public String sourceName = "湖南省国际工程咨询中心有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select(".news_co>ul>li:has(a)");
                ...
                Element nextPage = doc.select(".nextpage a:contains(下一页)").first();
                ...
                if (branch != null) {
                    ...
                    String date = "";
                    String content = "";
                    Element contentElement = doc.select("div.pageright>table").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("tr:has(div.news_info_co_title)").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                            Element timeElement = titleElement.nextElementSibling();
                        ...
                        contentElement.select("div.news_info_co_end").remove();
