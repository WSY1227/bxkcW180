package com.bidizhaobiao.data.Crawl.service.impl.Y04265;
 ...
 * 原网站：http://www.xhdeyy.com/news.aspx?mid=24
 * 主页：http://www.xhdeyy.com
 **/
@Service
public class Y04265_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    //列表界面
    public String listUrl = "http://www.xhdeyy.com/news.aspx?mid=24";
    //域名
    public String baseUrl = "http://www.xhdeyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04265";
    // 网站名称
    public String sourceName = "宣汉县第二人民医院";
    // 信息源
    ...
    // 设置城市
    public String city = "达州市";
    // 设置县
    public String district = "宣汉县";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("?mid=")) {
                ...
                Elements listElement = doc.select(".news-list.clearFix>li");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String title = a.select(".con").text().trim();
                ...
                if (nextPage != null && nextPage.attr("href").contains("?mid=") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select(".pnews-left.fl").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select(".title>.t").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select(".title").remove();
                        contentElement.select(".article-page").remove();
