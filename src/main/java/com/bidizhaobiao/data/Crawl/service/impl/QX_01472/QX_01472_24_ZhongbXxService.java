 ...
 * 原网站：http://www.lw.gov.cn/gzlwdsj/gkmlpt/index
 * 主页：http://www.lw.gov.cn
 **/

@Service("QX_01472_24_ZhongbXxService")
public class QX_01472_24_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://www.lw.gov.cn/gzlwdsj/gkmlpt/api/all/0?page=1&sid=200201";

    public String baseUrl = "http://www.lw.gov.cn";
    // 网站编号
    public String sourceNum = "01472-24";
    // 网站名称
            ...
            if (url.contains("page")) {
                ...
                if (articles.length() > 0) {
                    for (int i = 0; i < articles.length(); i++) {
                        ...
                        if (href.contains("http://www.gdzwfw.gov.cn/")) {
                            continue;
                        }
