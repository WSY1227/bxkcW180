package com.bidizhaobiao.data.Crawl.service.impl.DX011452;
 ...
 * 原网站：http://www.zhongminenergy.com/zbcg/zbxx/
 * 主页：http://www.zhongminenergy.com/
 **/
@Service
public class DX011452_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.zhongminenergy.com/zbcg/zbxx/";
    public String baseUrl = "http://www.zhongminenergy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX011452";
    // 网站名称
    public String sourceName = "中闽能源股份有限公司";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select("div.gl-box ul li:has(a)");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String link = "http://www.zhongminenergy.com/zbcg/zbxx"+id;
