 ...
 * 原网站：http://www.hnczs-swz.edu.cn/Category_18/Index.aspx
 * 主页：http://www.hnczs-swz.edu.cn
 **/
@Service
public class XX8391_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.hnczs-swz.edu.cn/Category_18/Index.aspx";
    public String baseUrl = "http://www.hnczs-swz.edu.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8391-2";
    // 网站名称
