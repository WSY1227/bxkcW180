...
@Service("DS_14124_8_ZhongbXxService")
public class DS_14124_8_ZhongbXxService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "14124-8";
    // 网站名称
    ...
    public Request getListRequest(int pageIndex) {
        ...
        try {
            ...
            String json = "{\"portalBiddingType\":\"2\",\"tenderProjectType\":\"A\",\"page\":" + pageIndex + ",\"limit\":10,\"_t\":1609813775}";
