package com.bidizhaobiao.data.Crawl.service.impl.DX013395;
 ...
 **/
@Service
public class DX013395_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://bsjt.bsjstzjt.com/list/bsjtbsjtPc/16/432/auto/20/0.html";
    public String baseUrl = "http://bsjt.bsjstzjt.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013395-1";
    // 网站名称
    public String sourceName = "保山市基础设施建设投资有限责任公司";
    // 信息源
