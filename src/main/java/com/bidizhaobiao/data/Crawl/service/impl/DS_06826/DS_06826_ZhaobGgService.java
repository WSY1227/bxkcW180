...
@Service("DS_06826_ZhaobGgService")
public class DS_06826_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("index")) {
                ...
                if (links.size() > 0) {
                    String key = "采购、询价、招标、比选、竞争性、谈判、磋商、遴选、选择、购买、单一来源";
