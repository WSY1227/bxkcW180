package com.bidizhaobiao.data.Crawl.service.impl.XX8422;
 ...
 * 原网站：http://www.txssg.cn/channels/672.html
 * 主页：http://www.txssg.cn
 **/
@Service
public class XX8422_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.txssg.cn/channels/672.html";
    public String baseUrl = "http://www.txssg.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8422-1";
    // 网站名称
    public String sourceName = "泰兴市第三高级中学";
    // 信息源
    ...
    // 设置城市
    public String city = "泰州";
    // 设置县
    public String district = "泰兴";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (!url.contains("/672/")) {
                ...
                Elements listElement = doc.select("div.channel-content-item.clearfix");
                if (listElement.size() > 0) {
                    ...
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(element.select(".year").text() + "-" + element.select(".date").text());
                        if (dateMat.find()) {
                ...
                if (nextPage != null && nextPage.attr("href").contains("/672") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.content-baseinfo").remove();
                        contentElement.select("div.content-footer").remove();
