 ...
 **/
@Service
public class SJ_19419_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    public Request getListRequest(int pageNumber, String viewState, String viewStateGenerator) {
        ...
        try {
            ...
            if (url.contains("?CRT_NTYPE=")) {
                ...
                if (nextPage != null && nextPage.attr("href").contains("__doPostBack") && serviceContext.isNeedCrawl()) {
                    ...
                    String viewState = doc.select("#__VIEWSTATE").first().attr("value");
                    String viewStateGenerator = doc.select("#__VIEWSTATEGENERATOR").first().attr("value");
                    page.addTargetRequest(getListRequest(serviceContext.getPageNum(), viewState, viewStateGenerator));
                }
            } else {
