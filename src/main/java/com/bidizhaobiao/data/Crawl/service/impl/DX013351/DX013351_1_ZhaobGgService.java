 ...
 * 原网站：http://ahhdlq.com/info/78345.html
 * 主页：http://ahhdlq.com
 **/
@Service
public class DX013351_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://ahhdlq.com/info/78345.html?page=1";
    public String baseUrl = "http://ahhdlq.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013351-1";
    // 网站名称
