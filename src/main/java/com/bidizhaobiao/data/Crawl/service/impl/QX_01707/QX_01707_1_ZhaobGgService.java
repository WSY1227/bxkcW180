 ...
 * 原网站：http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=701&jsgc=0100000&zfcg=&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=jygg
 * 主页：http://ggzy.huangzhou.gov.cn
 **/

@Service("QX_01707_1_ZhaobGgService")
public class QX_01707_1_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=701&jsgc=0100000&zfcg=&tdjy=&cqjy=&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&FromUrl=jygg&page=1";
            ...
            if (url.contains("page=")) {
                ...
                if (trs.size() > 1) {
                    for (int i = 0; i < trs.size() - 1; i++) {
                        ...
                        if (!href.contains("hyzbggzfcgDetail")) {
                            continue;
                        }
                        String id = href.replace("?", "&").trim();
                        String link = "http://ggzy.huangzhou.gov.cn/ceinwz/" + href;
