 ...
 * 原网站：http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=0&jsgc=&zfcg=&tdjy=&cqjy=0100000&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&xmlx=&FromUrl=jygg
 * 主页：http://ggzy.huangzhou.gov.cn
 **/

@Service("QX_01707_2_ChanqJyService")
public class QX_01707_2_ChanqJyService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://ggzy.huangzhou.gov.cn/ceinwz/WebInfo_List.aspx?newsid=0&jsgc=&zfcg=&tdjy=&cqjy=0100000&qtjy=&PubDateSort=1&ShowPre=1&CbsZgys=0&zbfs=&qxxx=0&showqxname=0&NewsShowPre=1&wsjj=0&showCgr=0&ShowOverDate=0&showdate=1&xmlx=&FromUrl=jygg&page=1";
...
//                        if (!href.contains("hyZbggTdjyDetail")) {
//                            continue;
//                        }
                        String id = href.substring(href.indexOf("=") + 1).trim();
                        String link = "http://ggzy.huangzhou.gov.cn/ceinwz/Hyzq/hyZbggTdjyDetail.aspx?sgzbbm=" + id;
