package com.bidizhaobiao.data.Crawl.service.impl.Y04850;
 ...
 * 原网站：https://www.shcnfb.cn/list/85.html
 * 主页：https://www.shcnfb.cn
 **/
@Service("Y04850_1_ZhaobGgService")
public class Y04850_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.shcnfb.cn/list/85.html";
    public String baseUrl = "https://www.shcnfb.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04850-1";
    // 网站名称
    public String sourceName = "上海市长宁区妇幼保健院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select("ul.news_lb1.md40>li:has(a)");
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.news_d1.left").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.ssj.md35.zt_9").remove();
                        contentElement.select("div.sgd").remove();
