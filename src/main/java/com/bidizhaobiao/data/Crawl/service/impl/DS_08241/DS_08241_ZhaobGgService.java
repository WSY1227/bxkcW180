package com.bidizhaobiao.data.Crawl.service.impl.DS_08241;
 ...
 * 程序员：董文锋
 * 日期：2020-09-03
 * 原网站：http://cl.nantong.gov.cn/ntscjrlhh/tzgg/tzgg.html
 **/

@Service
public class DS_08241_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public String listUrl = "http://cl.nantong.gov.cn/ntscjrlhh/tzgg/tzgg.html";
    public String baseUrl = "http://cl.nantong.gov.cn";
    public String[] keys = "邀请、招标、采购、询价、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌".split("、");
    public Pattern p = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "08241";
    // 网站名称
    public String sourceName = "南通市残疾人联合会";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(1000);
            if (url.contains("tzgg/tzgg")) {
                Document doc = page.getHtml().getDocument();
                Elements list = doc.select("div[id=initData] ul li:has(a)");
                if (list.size() > 0) {
                ...
                if (bn != null) {
                    ...
                    Element div = doc.select("div[class=page]").first();
                    if (div != null) {
