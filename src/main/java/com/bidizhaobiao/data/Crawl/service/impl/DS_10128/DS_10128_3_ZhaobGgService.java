 ...
 * 原网站：http://scjinkaijia.com/ArticleList/index/54
 * 主页：http://scjinkaijia.com
 **/

@Service("DS_10128_3_ZhaobGgService")
public class DS_10128_3_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://scjinkaijia.com/ArticleList/index/54";
    ...
    // 网站编号
    public String sourceNum = "10128-3";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            if (url.equals(listUrl)) {
                ...
                Elements lis = document.select("ul.newslist").select("li:has(a)");
                ...
                String content = "";
                Document document = Jsoup.parse(html);
                String date = document.select(".newsinfotime").text().replaceAll("[.|/|年|月]", "-");
