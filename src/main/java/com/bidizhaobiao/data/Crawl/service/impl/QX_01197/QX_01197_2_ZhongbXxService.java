...
/**
 * 程序员：唐家逸 日期：2021-11-01 原网站：首页/建设工程/中标候选人公示（仅抓取首页标题）
 * 主页：http://ggzy.np.gov.cn/sc/
 **/

@Service
public class  QX_01197_2_ZhongbXxService extends SpiderService implements PageProcessor {
	...
	// 网站编号
	public String sourceNum = "01197-2";
	// 网站名称
	...
	public void process(Page page) {
		...
		try {
			...
			if (url.equals(listUrl)) {
				...
				Element tab = doc.select("div[id=jsgccon4] ul").first();
				if (tab != null) {
