package com.bidizhaobiao.data.Crawl.service.impl.DS_24799;
 ...
 * 原网站：http://newsjs.jaas.ac.cn/xww/tzgg/index.html
 * 主页：http://newsjs.jaas.ac.cn
 **/
@Service
public class DS_24799_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://newsjs.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=185a0a9b7f1446509c9f52d8557e8321&pageId=3d9f59a9d9b346e4afd70fbe6ba170dc&parseType=bulidstatic&pageType=column&tagId=%E4%BF%A1%E6%81%AFlist&tplSetId=3fc23608986e4dc889bc80fd8569903a&paramJson=%7B%22pageNo%22%3A1%2C%22pageSize%22%3A15%7D";
    public String baseUrl = "http://newsjs.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24799";
    // 网站名称
    public String sourceName = "江苏省农业科学院农产品质量安全与营养研究所";
    // 信息源
        ...
        try {
            ...
            if (url.contains("/api-gateway")) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    String href = "http://newsjs.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=185a0a9b7f1446509c9f52d8557e8321&pageId=3d9f59a9d9b346e4afd70fbe6ba170dc&parseType=bulidstatic&pageType=column&tagId=%E4%BF%A1%E6%81%AFlist&tplSetId=3fc23608986e4dc889bc80fd8569903a&paramJson=%7B%22pageNo%22%3A" + serviceContext.getPageNum() + "%2C%22pageSize%22%3A15%7D";
