package com.bidizhaobiao.data.Crawl.service.impl.SJ_19557;
 ...
 * 原网站：http://gdzzxmgl.com/portal/list/index.html?id=11
 * 主页：http://gdzzxmgl.com
 **/
@Service
public class SJ_19557_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    //列表界面
    public String listUrl = "http://gdzzxmgl.com/portal/list/index.html?id=12";
    //域名
    public String baseUrl = "http://gdzzxmgl.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "19557-2";
    // 网站名称
    public String sourceName = "广东致正项目管理有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("?id=12")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("div.list-boxes>h2>a");
                ...
                if (nextPage != null && nextPage.attr("href").contains("?id=11") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String date = "";
                    String content = "";
                    Element contentElement = doc.select(".tc-box.article-box").first();
