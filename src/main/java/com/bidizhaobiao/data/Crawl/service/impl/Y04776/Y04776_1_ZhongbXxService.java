package com.bidizhaobiao.data.Crawl.service.impl.Y04776;
 ...
 * 原网站：https://www.btzxyy.com/lists/cid/61.jsp
 * 主页：https://www.btzxyy.com
 **/
@Service("Y04776_1_ZhongbXxService")
public class Y04776_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://www.btzxyy.com/lists/cid/61/current_page/1.jsp";
    public String baseUrl = "https://www.btzxyy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "Y04776-1";
    // 网站名称
    public String sourceName = "包头市中心医院";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/current_page")) {
                ...
                Elements listElement = doc.select("table.font_hei_12 tr:has(td[valign=bottom])");
                ...
                if (nextPage != null && nextPage.attr("href").contains("/current_page") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("td[bgcolor='#FFFFFF']>table").first();
                    if (contentElement == null) {
                        contentElement = doc.select(".contentAll").first();
                    }
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select(".font_hei_14").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                            contentElement.select(".va_m").remove();
                        } else {
                            contentElement.select(".title1").first();
                            if (titleElement != null) {
                                title = titleElement.text().trim();
                            }
                        }
