package com.bidizhaobiao.data.Crawl.service.impl.QX_24724;
 ...
 * 原网站：http://www.szmbjy.net/list.asp?classid=1
 * 主页：http://www.szmbjy.net
 **/
@Service
public class QX_24724_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.szmbjy.net/list.asp?classid=1";
    public String baseUrl = "http://www.szmbjy.net";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24724";
    // 网站名称
    public String sourceName = "苏州民办教育协会";
    // 信息源
            ...
            if (url.contains("?classid=")) {
                ...
                if (listElement.size() > 0) {
                    ...
                    for (Element element : listElement) {
                        ...
                        if (!link.contains("www.szmbjy.net")) {
                            link = baseUrl + link;
                        }
...
//                        branch.setDate(date);
                ...
                if (nextPage != null && nextPage.attr("href").contains("?classid=") && serviceContext.isNeedCrawl()) {
                    String href = "http://www.szmbjy.net/list.asp" + nextPage.attr("href").trim();
                ...
                if (branch != null) {
                    ...
                    String date = "";
                    String content = "";
                    Element contentElement = doc.select("#sdcms_content").first();
