package com.bidizhaobiao.data.Crawl.service.impl.DS_24801;
 ...
 * 原网站：http://leisure.jaas.ac.cn/gzdt/index.html
 * 主页：http://leisure.jaas.ac.cn
 **/
@Service
public class DS_24801_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://leisure.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=85e35a107e9d4ba4ae2a9c6f45204026&pageId=e1811c9d19e3479f983264640c2bd321&parseType=bulidstatic&pageType=column&tagId=%E5%86%85%E5%AE%B9%E5%88%97%E8%A1%A8&tplSetId=e9d9fb173978477b8a4db3ef38568191&paramJson=%7B%22pageNo%22%3A1%2C%22pageSize%22%3A15%7D";
    public String baseUrl = "http://leisure.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24801";
    // 网站名称
    public String sourceName = "江苏省农业科学院休闲农业研究所";
    // 信息源
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        if (titleElement != null) {
                            Element timeElement = titleElement.select(".postInfo").first();
