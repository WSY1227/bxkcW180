package com.bidizhaobiao.data.Crawl.service.impl.DS_24803;
 ...
 * 原网站：http://yh.jaas.ac.cn/tzgg/index.html
 * 主页：http://yh.jaas.ac.cn
 **/
@Service
public class DS_24803_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://yh.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=f8d944d4f82c4c8b9ba94b50b6e08536&pageId=a0003f8d5b8a417e86e4b2d9d06d1afc&parseType=bulidstatic&pageType=column&tagId=%E5%BD%93%E5%89%8D%E6%A0%8F%E7%9B%AElist&tplSetId=933dd16e964d47209c86251df4ad7005&paramJson=%7B%22pageNo%22%3A1%2C%22pageSize%22%3A20%7D";
    public String baseUrl = "http://yh.jaas.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24803";
    // 网站名称
    public String sourceName = "江苏沿海地区农科所";
    // 信息源
        ...
        try {
            ...
            if (url.contains("/api-gateway")) {
                ...
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    ...
                    String href = "http://yh.jaas.ac.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=f8d944d4f82c4c8b9ba94b50b6e08536&pageId=a0003f8d5b8a417e86e4b2d9d06d1afc&parseType=bulidstatic&pageType=column&tagId=%E5%BD%93%E5%89%8D%E6%A0%8F%E7%9B%AElist&tplSetId=933dd16e964d47209c86251df4ad7005&paramJson=%7B%22pageNo%22%3A" + serviceContext.getPageNum() + "%2C%22pageSize%22%3A20%7D";
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.newTips.mb10").remove();
