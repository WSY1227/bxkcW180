package com.bidizhaobiao.data.Crawl.service.impl.QX_24905;
 ...
 * 原网站：https://fg.nujiang.cn/html/gg/
 * 主页：https://fg.nujiang.cn
 **/
@Service
public class QX_24905_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://fg.nujiang.cn/html/gg/";
    public String baseUrl = "https://fg.nujiang.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24905-1";
    // 网站名称
    public String sourceName = "福贡石月亮网";
    // 信息源
        ...
        try {
            ...
            if (url.contains("/gg/")) {
                ...
                if (listElement.size() > 0) {
                    String key = "询标、需求、废旧、废置、报废、供应商、承销商、服务商、优选、择选、择优、选取、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、遴选、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
                ...
                Element nextPage = doc.select("#pagess a:contains(»)").first();
                if (nextPage != null && nextPage.attr("href").contains("/gg/") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.mtext").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("section>h2.title").first();
