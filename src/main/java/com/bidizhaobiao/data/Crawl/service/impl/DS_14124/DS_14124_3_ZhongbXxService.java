...
@Service("DS_14124_3_ZhongbXxService")
public class DS_14124_3_ZhongbXxService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "14124-3";
    // 网站名称
    ...
    public Request getListRequest(int pageIndex) {
        ...
        try {
            ...
            String json = "{\"portalBiddingType\":\"2\",\"tenderProjectType\":\"B\",\"page\":" + pageIndex + ",\"limit\":10,\"_t\":1609813775}";
