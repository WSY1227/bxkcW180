package com.bidizhaobiao.data.Crawl.service.impl.XX8346;
 ...
 * 原网站：http://ccssy.jleduyun.cn/index.php?r=space/school/theme/content/index&sid=df2609abd5924367a8ae4d9a258cc3b8&cid=43437
 * 主页：http://ccssy.jleduyun.cn
 **/
@Service("XX8346_1_ZhaobGgService")
public class XX8346_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://ccssy.jleduyun.cn/index.php?r=space/school/theme/content/index&sid=df2609abd5924367a8ae4d9a258cc3b8&cid=43437";
    public String baseUrl = "http://ccssy.jleduyun.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX8346-1";
    // 网站名称
    public String sourceName = "长春市实验中学";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/index&")) {
                ...
                Elements listElement = doc.select("table.y_table>tbody>tr");
                ...
                Element nextPage = doc.select("span.on").first().nextElementSibling();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.zx_detail.clearfix").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div.message").remove();
