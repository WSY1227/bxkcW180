package com.bidizhaobiao.data.Crawl.service.impl.DS_14322;
 ...
 * 原网站：http://sthjj.czs.gov.cn/gsgg/default.htm
 * 主页：http://sthjj.czs.gov.cn
 **/
@Service
public class DS_14322_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://sthjj.czs.gov.cn/gsgg/default.htm";
    public String baseUrl = "http://sthjj.czs.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "14322";
    // 网站名称
    public String sourceName = "郴州市生态环境局";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.contains("/default")) {
                ...
                Elements listElement = doc.select(".fz-tab>table>tbody>tr");
                ...
                if (nextPage != null && nextPage.attr("href").contains("default")&& !nextPage.attr("href").contains("default.jsp") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.xlnk").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("h4,h6").remove();
                        contentElement.select("#div_div").remove();
                        contentElement.select("#div_div").remove();
                        contentElement.select("#Canvas").remove();
                        contentElement.select(".share-box-xl").remove();
