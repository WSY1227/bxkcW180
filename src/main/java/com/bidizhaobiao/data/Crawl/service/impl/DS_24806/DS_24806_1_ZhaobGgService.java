package com.bidizhaobiao.data.Crawl.service.impl.DS_24806;
 ...
 * 原网站：http://zzggrc.zzzcyz.com/news/0/1/list.html?type=ZXGG
 * 主页：http://zzggrc.zzzcyz.com
 **/
@Service
public class DS_24806_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://zzggrc.zzzcyz.com/news/421/1/list.html?keyword=";
    public String baseUrl = "http://zzggrc.zzzcyz.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24806-1";
    // 网站名称
    public String sourceName = "郑州市公共就业人才服务中心人才网";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/list.htm")) {
                ...
                Elements listElement = doc.select(".LimgRtextBox.marB40>div a");
                if (listElement.size() > 0) {
                    String key = "询标、废旧、废置、处置、报废、供应商、承销商、服务商、调研、优选、择选、择优、选取、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、遴选、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
                ...
                if (nextPage != null && nextPage.attr("href").contains("/list.htm") && serviceContext.isNeedCrawl()) {
                ...
                if (branch != null) {
                    ...
                    String date = "";
                    String content = "";
                    Element contentElement = doc.select("div.zxDetail.marT30").first();
                    if (contentElement != null) {
                        ...
                        Element timeElement = contentElement.select(".clearfix.textCenter.ylNum.marT10").first();
                        if (timeElement != null) {
                        ...
                        timeElement.remove();
                        contentElement.select("div.zx-bottomNav").remove();
