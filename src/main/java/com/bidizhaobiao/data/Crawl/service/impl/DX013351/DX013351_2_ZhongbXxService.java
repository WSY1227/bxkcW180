package com.bidizhaobiao.data.Crawl.service.impl.DX013351;
 ...
 * 原网站：http://ahhdlq.com/info/78347.html
 * 主页：http://ahhdlq.com
 **/
@Service
public class DX013351_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://ahhdlq.com/info/78347.html?page=1";
    public String baseUrl = "http://ahhdlq.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX013351-2";
    // 网站名称
    public String sourceName = "安徽虹达道路桥梁工程有限公司";
    // 信息源
    ...
    public void startCrawl(int ThreadNum, int crawlType) {
        ...
        try {
            ...
            if (url.contains("?page=")) {
                ...
                Elements listElement = doc.select(".TTXW_LIST>ul>li:has(a)");
                ...
                Element nextPage = doc.select(".pagernumber a:contains(下一页)").first();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("#rightObj").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.display_title>h1").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("div.display_title>div").remove();
                        contentElement.select(".diplay_foot.clearfix").remove();
                        contentElement.select("ul.page_up_dn").remove();
