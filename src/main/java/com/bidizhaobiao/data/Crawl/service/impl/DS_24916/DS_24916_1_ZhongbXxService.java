package com.bidizhaobiao.data.Crawl.service.impl.DS_24916;
 ...
 * 原网站：http://lycy.pingliang.gov.cn/zfxxgk/fdzdgknr/tzgg/index.html
 * 主页：http://lycy.pingliang.gov.cn/
 **/
@Service
public class DS_24916_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://lycy.pingliang.gov.cn/api-gateway/jpaas-publish-server/front/page/build/unit?webId=3cbe3d9dabd0473db377f4ad5a1ec1e7&pageId=3dbc80dc60d045a39c3903e487d59b46&parseType=bulidstatic&pageType=column&tagId=%E4%BF%A1%E6%81%AF%E5%85%AC%E5%BC%80%E5%86%85%E5%AE%B92&tplSetId=e234c7a3af7f4626b1059f1b9adafc21&paramJson=%7B%22pageNo%22:1,%22pageSize%22:%2215%22%7D";
    public String baseUrl = "http://lycy.pingliang.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "24916-1";
    // 网站名称
    public String sourceName = "平凉市林业和草原局";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/api-gateway")) {
                Document doc = Jsoup.parse(JSONObject.parseObject(page.getRawText()).getJSONObject("data").getString("html"));
                ...
                if (serviceContext.getPageNum() == 1) {
                    int countNum = Integer.parseInt(doc.select(".pagination").attr("count"));
                    serviceContext.setMaxPage(countNum % 15 == 0 ? countNum / 15 : countNum / 15 + 1);
                }
                if (serviceContext.getPageNum() < serviceContext.getMaxPage() && serviceContext.isNeedCrawl()) {
                    serviceContext.setPageNum(serviceContext.getPageNum() + 1);
                    String href = listUrl.replace("pageNo%22:1", "pageNo%22:" + serviceContext.getPageNum());
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        contentElement.select("ul.gn.clearfix").remove();
                        contentElement.select(".ud").remove();
                        contentElement.select("div:has(#div_div)").last().remove();
